import { Image, ImageBackground, KeyboardAvoidingView, ScrollView, StyleSheet, Text, ToastAndroid, TouchableOpacity, View } from 'react-native'
...
import { DateInputBox, PhoneNumberInput, TextAreaBox, TextInputBox } from '../../../../../components/framework/input'
...
import { GetAllCountryApi, GetAllGenderApi, UpdateMyProfileApi } from '../../../../../api/app/user'
    ...
    useEffect(() => {
        const fetchCountries = async () => {
            ...
            if (res && res.success) {
                ...
                if (user.country_id) {
                    ...
                    if (selected) {
                        ...
                        if (selected.phone_code) {
                            setCallingCode(selected.phone_code);
                        }
                ...
                console.log("Failed to fetch countries or invalid response");
            }
        };
        fetchCountries();
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.WHITE }}>
            <ScrollView contentContainerStyle={{ paddingBottom: 60 }}>
                ...
                <KeyboardAvoidingView style={styles.body}>
                    ...
                    <Spacer height={10} />
                    <TextAreaBox
                        placeholder='Enter Address' height={80}
                        value={address}
                        setValue={setAddress}
                    />
                    <Spacer height={10} />
                    ...
                    <DropdownBox
                        ...
                        setValue={(name) => {
                            ...
                            setSelectedCountry(countryObj); // FIXED: Set selected country
                        }}
                        placeholder="Select Country"
                        options={countryOptions.map(c => c.name)} // FIXED: Map country options
                    />
                    <Spacer height={10} />
                    <TextInputBox
